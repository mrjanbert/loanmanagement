...
<body class="hold-transition register-page">
    ...
    <div class="register-box">
        <div class="card card-outline card-primary my-5">
            ...
            <div class="card-body">
                <form action="./config/create-user.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="contactNumber" maxlength="10" placeholder="Ex. 9123456789" required>
                        </div>
                    </div>
                    <div class="col-12">
                        <label>Email</label>
