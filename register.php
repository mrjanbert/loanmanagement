                        ...
                        <div class="col-lg-12 col-xl-11">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="config/create-user.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="text-lg-start">
                                        <p class="text-center fw-bold mt-1 pt-1 mb-5">Already have an account? <a href="login.php" class="link-danger">Login</a></p>
                                    </div>
                                </div>
