    ...
    ?>
      <tr>
        ...
        <td class="text-center">
          <a class="btn btn-primary btn-xs my-1 edit_payment" data-id="<?= $id ?>" data-interest="<?= ($interest != 0) ? $interest : ''; ?>" data-penalty="<?= ($penalty != 0) ? $penalty : ''; ?>" data-receipt_no="<?= $receipt_no ?>" data-payment_amount="<?= $payment_amount ?>" data-payment_date="<?= $payment_date ?>" data-toggle="modal" data-target="#edit_payment" href="javascript:void(0)">
