...
<?php if (isset($_SESSION['role_name']) && (trim($_SESSION['role_name']) != ('Unknown User'))) : ?>
    ...
    <?php if (isset($_SESSION['role_name']) && (($_SESSION['role_name'] == 'Cashier'))) {  ?>
        ...
        <div class="modal fade" id="adjustments">
            <div class="modal-dialog modal-md modal-dialog-centered">
                <form action="../../config/create-adjustment.php" method="POST" autocomplete="off">
                    <div class="modal-content card-outline card-primary">
                        <div class="modal-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-border" name="penalty" placeholder="Enter Amount">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                        ...
                        <div class="modal-footer justify-content-end">
                            <button type="submit" name="addadjustment" class="btn btn-primary">
                                Save
                            </button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">
                                Cancel
